package org.github.caishijun.eshop.cache.ha.controller;

import com.netflix.hystrix.HystrixCommand;
import com.netflix.hystrix.HystrixObservableCommand;
import org.github.caishijun.eshop.cache.ha.http.HttpClientUtils;
import org.github.caishijun.eshop.cache.ha.hystrix.command.GetBrandNameCommand;
import org.github.caishijun.eshop.cache.ha.hystrix.command.GetCityNameCommand;
import org.github.caishijun.eshop.cache.ha.hystrix.command.GetProductInfoCommand;
import org.github.caishijun.eshop.cache.ha.hystrix.command.GetProductInfosCommand;
...
public class CacheController {
    ...
    // http://localhost:8081/change/product?productId=1
...
//		}
    ...
    /**
     * 一次性批量查询多条商品数据的请求
     * http://localhost:8081/getProductInfos?productIds=1,2,3,4,5
     */
