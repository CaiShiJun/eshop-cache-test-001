                    ...
                    for(Map.Entry<Long, Long> productCountEntry : productCountList) {
                        if(productCountEntry.getValue() > 10 * avgCount) {
                            ...
                            String[] appNginxURLs = new String[]{
                                    "http://192.168.74.101/hot?productId=" + productCountEntry.getKey() + "&productInfo=" + response,
                                    "http://192.168.74.102/hot?productId=" + productCountEntry.getKey() + "&productInfo=" + response
                            };
