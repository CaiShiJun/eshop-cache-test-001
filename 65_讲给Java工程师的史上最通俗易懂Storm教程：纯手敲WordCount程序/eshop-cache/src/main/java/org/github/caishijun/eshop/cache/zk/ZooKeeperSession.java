package org.github.caishijun.eshop.cache.zk;
...
public class ZooKeeperSession {
    ...
    public ZooKeeperSession() {
        ...
        try {
            this.zookeeper = new ZooKeeper(
                    "192.168.74.101:2181,192.168.74.102:2181,192.168.74.103:2181",
                    50000,
    ...
    public void acquireDistributedLock(Long productId) {
        ...
        try {
            zookeeper.create(path, "".getBytes(),       // 创建该商品id临时节点，存储一个空字符串。
                    Ids.OPEN_ACL_UNSAFE,        // Ids.OPEN_ACL_UNSAFE 不做权限控制
                    CreateMode.EPHEMERAL);      // CreateMode.EPHEMERAL 创建一个临时的节点
